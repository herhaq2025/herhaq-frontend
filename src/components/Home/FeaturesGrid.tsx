      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <h2 className="text-4xl sm:text-5xl font-bold text-[#333333] mb-6">
            {language === 'en' ? 'How Haq Can Help You' : 'حق آپ کی کیسے مدد کر سکتا ہے'}
          </h2>
          <p className="text-xl text-[#333333] max-w-3xl mx-auto leading-relaxed">
            {language === 'en' 
              ...
              : 'قانونی علم اور مدد کے ساتھ آپ کو بااختیار بنانے کے لیے ڈیزائن کیے گئے ہمارے جامع ٹولز کو دریافت کریں'
            }
          </p>
        </motion.div>
